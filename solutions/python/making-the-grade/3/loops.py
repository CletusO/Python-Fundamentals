...
def round_scores(student_scores):
    ...
    """
    list_student_scores = [round(numbers) for numbers in student_scores]
...
def letter_grades(highest):
    ...
    failing_grade = 40
    number_of_grades = 4
    increment = round((highest - failing_grade) / number_of_grades)
    return list(range(failing_grade+1, highest, increment))
